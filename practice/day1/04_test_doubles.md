...
**Задача:** Написать тесты на выигрыш/проигрыш, которые зависят от значения кубика. [Код упражнения](/practice/day1/dices/)
...
**Задача:** Понять разницу между тестами на поведение и тестами на состояние. [Код упражнения](/practice/day1/dices/)
