# Качество тестов
Timing: 30 min
## Антипаттерны написания тестов
- Много красных тестов
- Автогенеренные тесты
- Элементарный код
- Погоня за code coverage

## Три столпа модульных тестов
### Flip: Три столпа модульных тестов
> Обсуждение
#### Вызывают доверие
...
### Demo
Проектор с примерами кода от тренеров на тесты и тестовые дублёры.
