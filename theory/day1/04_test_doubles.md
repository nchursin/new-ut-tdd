...
## Практика
[Практика](/practice/day1/04_test_doubles.md) - использовать stub в упражнении dices

## Тесты на поведение/состояние
![behaviour and state testing](assets/behaviour-state.png)

## Практика
[Практика](/practice/day1/04_test_doubles.md) - использовать mock в упражнении dices

## Дебриф
Где бы вы в своей работе могли бы иcпользовать дублёры? На что добавили бы дублёры?
