...
Посмотрите на тесты, которые вы написали. Обратите внимание на то, что логика инициализации во многих тестах дублируется: чтобы протестировать логику ставок, нужно создать игрока, дать ему начальное количество фишек, и только потом можно приступать к логике теста. Инициализация используются, чтобы:
...
```
## Практика
[Практика](/practice/day1/06_fixtures.md) - оптимизировать инициализацию с использованием фикстур
